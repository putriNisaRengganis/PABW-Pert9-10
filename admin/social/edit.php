...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="card-body">
                                <input type="hidden" name="id" value="<?=$id ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_sosmed" class="form-control" placeholder="Masukan Nama Sosmed" value="<?= $nama_sosmed ?>" required>
                                    </div>
                        <div class="form-group">
                            <label>Link</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label">Pilih File Ikon</label>
                                </div>
                            </div>
                        </div>
                        </div>
    ...
    <strong>Copyright &copy; Putri Nisa Rengganis
