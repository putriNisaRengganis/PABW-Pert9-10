    ...
    <div id="templatemo_wrapper">
        ...
        <div id="templatemo_slider"><span class="sliderframe"></span>
             <div class="slider-wrapper theme-orman">
                <div id="slider" class="nivoSlider">
                    ...
                    ?>
                    <img src="admin/slider/gambarSlider/<?=$data['gambar']?>" alt="gambarSlider"/>
                    <?php } ?>
                </div>
            </div> 
        ...
        <div id="templatemo_main"><span class="mf mft"></span><span class="mf mfb"></span>
            ...
            include "koneksi.php";
                ...
                FROM data_barang INNER JOIN kategori ON data_barang.id_kategori = kategori.id 
                WHERE id_kategori = '$id' ORDER BY data_barang.id DESC");   
                while ($data = mysqli_fetch_array($query)) {
            ?>
                <div class="col col_3">
